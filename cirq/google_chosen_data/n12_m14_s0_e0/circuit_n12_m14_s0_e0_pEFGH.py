...
#     noisy_qc = CIRCUIT.with_noise(cirq.NoiseModel.from_noise_model_like(cirq.depolarize(0.0016)))
#     noisy_qc.append(cirq.measure(noisy_qc.all_qubits()))
#     result = qsimcirq.QSimSimulator().run(noisy_qc, repetitions=1000)
#     print(result)
